...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container-narrow">
        <div class="jumbotron">
			<h1 style="color:white">SQL Injection - Ambiente de treinamento</h1>
			<p class="lead" style="color:white">
				Um ambiente desenvolvido para praticar e aprender a detecção e exploração manual de falhas de injeção de SQL
			</p>
        </div>
		<br />
    <div class="row marketing">
        <div style="border:1px solid #000000; padding: 10px">
          <b>Cadastre novos usuários na página de cadastro</b><br />
        <!--<ul> 
          <li>bob:password</li>
    ...
    <div style="border:1px solid #000000; padding: 10px">
		  <h4><a href="register.php" style="color:#B31D14">register.php - Página de cadastro de usuários</a></h4>
          <p>Esta página pode ser usada para criar usuários que serão usados em toda a plataforma.</p>
		
          <h4><a href="login1.php" style="color:#B31D14">login1.php - Página de login e de treino para Injeção SQL</a></h4>
          <p>Esta página contém de forma simples uma falha de injeção SQL. Os erros detalhados, podem ser usados para enumerar colunas e ignorar completamente a autenticação do usuário</p>
			<!--
